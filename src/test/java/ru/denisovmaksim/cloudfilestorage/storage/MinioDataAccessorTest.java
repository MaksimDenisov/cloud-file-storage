...
public class MinioDataAccessorTest {
    ...
    void saveAndGetObject() throws IOException {
        ...
        FileObject actual = minioDataAccessor.getObject(USER_ID, "folder/file.txt");
    ...
    void getManyObjects() throws IOException {
        ...
        List<FileObject> actual = minioDataAccessor.getObjects(USER_ID, "folder/");
    ...
    void copyManyObjects() throws IOException {
        ...
        List<FileObject> actual = minioDataAccessor.getObjects(USER_ID, "root/copiedFolder/");
    ...
    void copyObject() throws IOException {
        ...
        FileObject actual = minioDataAccessor.getObject(USER_ID, "folder/copy-file.txt");
