...
@Component
@Slf4j
public class MinioDataAccessor extends MinioBaseAccessor{

    public MinioDataAccessor(MinioClient minioClient, MinioPathResolver resolver, @Value("${app.bucket}")String bucket) {
